...
export const Route=createFileRoute("/onboarding/complete")({head:()=>({meta:[{title:"Workspace — SMAA"},{name:"description",content:"Guided onboarding is not part of this build."},{property:"og:title",content:"Workspace — SMAA"},{property:"og:description",content:"Guided onboarding is not part of this build."},{property:"og:type",content:"website"},{name:"twitter:card",content:"summary_large_image"}]}),component:Page});
